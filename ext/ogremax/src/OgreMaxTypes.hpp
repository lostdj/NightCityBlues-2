...
namespace OgreMax
{
    namespace Types
    {
        ...
        struct ObjectExtraData
        {
            ...
            /** Determines if there are any note tracks */
            bool HasNoteTracks() const
            {
                return !this->noteTracks.isNull() && this->noteTracks->size() > 0;
            }
        ...
        struct CameraParameters : ObjectParameters
        {
            ...
            Ogre::Real orthoWidth, orthoHeight;
